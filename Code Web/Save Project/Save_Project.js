   ...
   var playerindexYouTube1;
   function onYouTubeIframeAPIReady() {
      playerindexYouTube1 = new YT.Player('indexYouTube1', {
         events: {
         }
      });
   }
   ...
   {
      var indexjQueryDatePicker1Options =
      {
         dateFormat: 'mm/dd/yy',
         changeMonth: true,
         changeYear: true,
      ...
      $("#indexjQueryDatePicker1").datepicker(indexjQueryDatePicker1Options);
      $("#indexjQueryDatePicker1").datepicker("setDate", "new Date()");
      $("#indexjQueryDatePicker1").datepicker("option", $.datepicker.regional['vi']);
      $("#indexjQueryDatePicker1").change(function()
      {
         $('#indexjQueryDatePicker1_input').attr('value',$(this).val());
      });
      ...
      $('#wb_indexPhotoGallery1 img').attr('title', '');$('#wb_indexPhotoGallery1').galleria({height:0.35});
   });
